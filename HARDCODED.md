...
| `STRIPE_SECRET_KEY` | `sk_live_…Yrmto541` | Clave secreta **LIVE** de la cuenta Stripe de Wardkitten. ⚠️ Rotar y migrar a sealed-secrets. |
| `STRIPE_WEBHOOK_SECRET` | `whsec_jo9KN…C9094` | Signing secret del webhook `/webhooks/stripe` (modo live). |
